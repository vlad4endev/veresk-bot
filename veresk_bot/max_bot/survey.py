        ...
        if sealed_revealed:
            ...
            if wheel_kb:
                wheel_text = (
                    ...
                    "_Если MAX пишет «не удалось открыть мини-приложение» — "
                    "в кабинете партнёра MAX у бота в «Расширенных настройках» "
                    "должен быть URL:_ `https://admin.veresk-flowers.ru/miniapp/`"
                )
